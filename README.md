...
The `entities.json` is a JSON-formatted configuration file that defines various entities and their fields.
You can alter the definition by changing the entities.json file. You can use this file to map your schema to a number of entities that are generated by the script.
